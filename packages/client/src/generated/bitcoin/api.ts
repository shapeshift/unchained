...
export const V1ApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getAccount: async (pubkey: string, options: any = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/v1/account/{pubkey}`.replace(`{${'pubkey'}}`, encodeURIComponent(String(pubkey)))
    ...
    getTxHistory: async (
      ...
      const localVarPath = `/api/v1/account/{pubkey}/txs`.replace(`{${'pubkey'}}`, encodeURIComponent(String(pubkey)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    getUtxos: async (pubkey: string, options: any = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/v1/account/{pubkey}/utxos`.replace(`{${'pubkey'}}`, encodeURIComponent(String(pubkey)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
...
export const V1ApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getAccount(
      pubkey: string,
      options?: any
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BitcoinAccount>> {
    ...
    async getTxHistory(
      ...
      contract?: string,
      options?: any
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TxHistory>> {
    ...
    async getUtxos(
      pubkey: string,
      options?: any
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Utxo>>> {
...
export const V1ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    getTxHistory(
      ...
      contract?: string,
      options?: any
    ): AxiosPromise<TxHistory> {
      return localVarFp
        .getTxHistory(pubkey, page, pageSize, contract, options)
...
export class V1Api extends BaseAPI {
  ...
  public getAccount(requestParameters: V1ApiGetAccountRequest, options?: any) {
    return V1ApiFp(this.configuration)
      .getAccount(requestParameters.pubkey, options)
  ...
  public getUtxos(requestParameters: V1ApiGetUtxosRequest, options?: any) {
    return V1ApiFp(this.configuration)
      .getUtxos(requestParameters.pubkey, options)
      .then((request) => request(this.axios, this.basePath))
  }
  ...
  public sendTx(requestParameters: V1ApiSendTxRequest, options?: any) {
    return V1ApiFp(this.configuration)
      .sendTx(requestParameters.sendTxBody, options)
      .then((request) => request(this.axios, this.basePath))
  }
}
