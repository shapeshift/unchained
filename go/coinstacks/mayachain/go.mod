module github.com/shapeshift/unchained/coinstacks/mayachain
...
require (
	...
	gitlab.com/mayachain/dashd-go v0.26.1-0.20230718184409-5795f450433c // indirect
...
replace (
	...
	github.com/shapeshift/unchained/pkg/mayachain => ../../pkg/mayachain
