...
func NewTxResponse(jsonrpc string, id int32, result TxResponseResult) *TxResponse {
	this := TxResponse{}
...
func (o *TxResponse) GetJsonrpc() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *TxResponse) GetJsonrpcOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TxResponse) SetJsonrpc(v string) {
	o.Jsonrpc = v
}

// GetId returns the Id field value
func (o *TxResponse) GetId() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TxResponse) GetIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *TxResponse) SetId(v int32) {
	o.Id = v
}

// GetResult returns the Result field value
func (o *TxResponse) GetResult() TxResponseResult {
	if o == nil {
		var ret TxResponseResult
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TxResponse) GetResultOk() (*TxResponseResult, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TxResponse) SetResult(v TxResponseResult) {
	o.Result = v
}
