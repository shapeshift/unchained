...
func (o *BlockResponse) GetId() int32 {
	if o == nil || o.Id == nil {
		var ret int32
		return ret
	}
...
func (o *BlockResponse) GetIdOk() (*int32, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return o.Id, true
...
func (o *BlockResponse) HasId() bool {
	if o != nil && o.Id != nil {
		return true
	}
...
func (o *BlockResponse) SetId(v int32) {
	o.Id = &v
}

// GetJsonrpc returns the Jsonrpc field value if set, zero value otherwise.
func (o *BlockResponse) GetJsonrpc() string {
...
// and a boolean to check if the value has been set.
func (o *BlockResponse) GetJsonrpcOk() (*string, bool) {
	if o == nil || o.Jsonrpc == nil {
		return nil, false
	}
...
func (o *BlockResponse) HasJsonrpc() bool {
	if o != nil && o.Jsonrpc != nil {
		return true
	}
...
func (o *BlockResponse) SetJsonrpc(v string) {
	o.Jsonrpc = &v
}

// GetResult returns the Result field value if set, zero value otherwise.
func (o *BlockResponse) GetResult() BlockComplete {
...
// and a boolean to check if the value has been set.
func (o *BlockResponse) GetResultOk() (*BlockComplete, bool) {
	if o == nil || o.Result == nil {
		return nil, false
	}
...
func (o *BlockResponse) HasResult() bool {
	if o != nil && o.Result != nil {
		return true
	}
...
func (o *BlockResponse) SetResult(v BlockComplete) {
	o.Result = &v
}
