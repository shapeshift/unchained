...
func (o *Validator) GetPubKey() PubKey {
...
func (o *Validator) GetPubKeyOk() (*PubKey, bool) {
	if o == nil || o.PubKey == nil {
		return nil, false
	}
...
func (o *Validator) HasPubKey() bool {
	if o != nil && o.PubKey != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Validator) GetVotingPowerOk() (*int32, bool) {
	if o == nil || o.VotingPower == nil {
		return nil, false
	}
...
func (o *Validator) HasVotingPower() bool {
	if o != nil && o.VotingPower != nil {
		return true
	}
...
// SetVotingPower gets a reference to the given int32 and assigns it to the VotingPower field.
func (o *Validator) SetVotingPower(v int32) {
	o.VotingPower = &v
}
...
func (o *Validator) HasAddress() bool {
	if o != nil && o.Address != nil {
		return true
	}
