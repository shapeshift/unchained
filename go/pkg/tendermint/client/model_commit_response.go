...
type CommitResponse struct {
	...
	Id int32 `json:"id"`
	Result CommitResponseResult `json:"result"`
}
...
func NewCommitResponse(jsonrpc string, id int32, result CommitResponseResult) *CommitResponse {
	this := CommitResponse{}
...
func (o *CommitResponse) GetJsonrpc() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CommitResponse) GetJsonrpcOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommitResponse) SetJsonrpc(v string) {
	o.Jsonrpc = v
}

// GetId returns the Id field value
func (o *CommitResponse) GetId() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CommitResponse) GetIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *CommitResponse) SetId(v int32) {
	o.Id = v
}

// GetResult returns the Result field value
func (o *CommitResponse) GetResult() CommitResponseResult {
	if o == nil {
		var ret CommitResponseResult
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CommitResponse) GetResultOk() (*CommitResponseResult, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CommitResponse) SetResult(v CommitResponseResult) {
	o.Result = v
}
