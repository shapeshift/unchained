...
export const getVolumeClaimTemplates = (serviceName: string, storageSize: string, snapshots?: VolumeSnapshot[]): Array<k8s.types.input.core.v1.PersistentVolumeClaim> => {
